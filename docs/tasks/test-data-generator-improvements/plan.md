...
5. **Schema persistence** *(in progress)*: `useSchemaTemplates` now supports pluggable stores with async Supabase-ready API endpoints; local store remains default until Supabase schema lands.
