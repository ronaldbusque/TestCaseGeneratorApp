...
export const fakerCategories: FakerCategory[] = [
  ...
  },
  {
    ...
    types: [
      ...
      { name: 'Base64 Image URL', description: 'Base64 encoded image urls like: data:image/png;base64,iVBORIrwA...' },
      { name: 'Bitcoin Address', description: '1EZbqbWbFvsWv67RHjqZryMBk8dYvqpfn4, 1HgxKTcbJsVZZ7MRha34vnwKx4qSAMKtnA' }
    ]
  },
  {
    name: 'Commerce',
